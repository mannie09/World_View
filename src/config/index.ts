...
// VITE_VARIANT=tech → tech.worldview.app (tech-focused)
// VITE_VARIANT=full → worldview.app (geopolitical)
// VITE_VARIANT=finance → finance.worldview.app (markets/trading)
