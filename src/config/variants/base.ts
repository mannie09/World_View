...
export const STORAGE_KEYS = {
  ...
  disabledFeedsSchema: 'worldview-disabled-feeds-schema',
  liveChannels: 'worldview-live-channels',
  mapMode: 'worldview-map-mode',          // 'flat' | 'globe'
  activeChannel: 'worldview-active-channel',
  webcamPrefs: 'worldview-webcam-prefs',
} as const;
