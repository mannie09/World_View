...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  conflicts: {
    ...
    source: 'WorldView conflict-zone registry, UCDP/ACLED conflict context, and documented boundary metadata such as the Korean DMZ.',
  ...
  ciiChoropleth: {
    ...
    source: 'WorldView CII scoring service using conflict, unrest, advisories, cyber, AIS, aviation, natural-event, and news signals.',
  ...
  natural: {
    ...
    evidence: ['docs/data-sources.mdx', 'docs/architecture.mdx', 'server/worldview/natural/v1/list-natural-events.ts'],
  },
  flights: {
    key: 'flights',
    coverage: 'curated',
  ...
  ais: {
    ...
    source: 'AISStream relay snapshots, WorldView maritime service, and chokepoint disruption classifiers.',
  ...
  waterways: {
    ...
    source: 'WorldView strategic-waterways registry with supply-chain chokepoint status overlays from AIS, NGA warnings, and PortWatch-derived feeds.',
    ...
    evidence: ['docs/architecture.mdx', 'docs/data-sources.mdx', 'src/config/geo.ts', 'server/worldview/supply-chain/v1/get-chokepoint-status.ts'],
  },
  tradeRoutes: {
    key: 'tradeRoutes',
    coverage: 'curated',
    ...
    source: 'WorldView trade-route registry plus supply-chain chokepoint status and transit summaries.',
  ...
  cyberThreats: {
    ...
    evidence: ['docs/data-sources.mdx', 'docs/architecture.mdx', 'scripts/seed-cyber-threats.mjs', 'server/worldview/cyber/v1/list-cyber-threats.ts'],
  },
  hotspots: {
    key: 'hotspots',
    coverage: 'curated',
    ...
    source: 'WorldView hotspot registry, RSS/GDELT news intelligence, hotspot escalation scoring, military activity, and CII context.',
