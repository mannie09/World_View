...
// server/worldview/resilience/v1/_dimension-scorers.ts). Duplicated
...
// `server/worldview/resilience/v1/_dimension-scorers.ts`. When a dim
...
// Mirrors server/worldview/resilience/v1/_shared.ts. Keep this table
...
// server/worldview/resilience/v1/_dimension-scorers.ts. The doc
