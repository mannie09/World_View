...
import type { ListFeedDigestResponse } from '@/generated/client/worldview/news/v1/service_client';
import type { GetSectorSummaryResponse, ListMarketQuotesResponse, ListCommodityQuotesResponse } from '@/generated/client/worldview/market/v1/service_client';
import type { SectorValuation } from '@/components/MarketPanel';
import { mountCommunityWidget } from '@/components/CommunityWidget';
import { ResearchServiceClient } from '@/generated/client/worldview/research/v1/service_client';
import {
  MarketPanel,
  StockAnalysisPanel,
  StockBacktestPanel,
...
import type { NewsItem as ProtoNewsItem, ThreatLevel as ProtoThreatLevel } from '@/generated/client/worldview/news/v1/service_client';
...
export class DataLoaderManager implements AppModule {
  ...
  private async _collectRegimeContext(): Promise<RegimeMacroContext | undefined> {
    try {
      ...
      const { MarketServiceClient } = await import('@/generated/client/worldview/market/v1/service_client');
  ...
  private async _collectYieldCurveContext(): Promise<YieldCurveContext | undefined> {
    try {
      const { EconomicServiceClient } = await import('@/generated/client/worldview/economic/v1/service_client');
      const { getRpcBaseUrl } = await import('@/services/rpc-client');
  ...
  async loadForecasts(): Promise<void> {
    try {
      const hydrated = getHydratedData('forecasts') as { predictions?: import('@/generated/client/worldview/forecast/v1/service_client').Forecast[]; generatedAt?: number } | undefined;
  ...
  async loadIntelligenceSignals(): Promise<void> {
    ...
    const hydratedUcdp = getHydratedData('ucdpEvents') as import('@/generated/client/worldview/conflict/v1/service_client').ListUcdpEventsResponse | undefined;
  ...
  async loadEconomicStress(): Promise<void> {
    try {
      ...
      const hydrated = getHydratedData('economicStress') as import('@/generated/client/worldview/economic/v1/service_client').GetEconomicStressResponse | undefined;
