...
import type { Earthquake } from '@/generated/client/worldview/seismology/v1/service_client';
...
// Keep these aligned with server/worldview/intelligence/v1/_risk-config.ts.
