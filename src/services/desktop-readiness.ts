...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/worldview/conflict/v1/handler.ts', 'server/worldview/infrastructure/v1/handler.ts', 'server/worldview/cyber/v1/handler.ts', 'server/worldview/maritime/v1/handler.ts', 'server/worldview/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/worldview/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/worldview/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/worldview/military/v1/handler.ts'],
    locality: 'api-key',
