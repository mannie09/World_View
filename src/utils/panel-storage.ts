export const PANEL_SPANS_KEY = 'worldview-panel-spans';
export const PANEL_COL_SPANS_KEY = 'worldview-panel-col-spans';
export const PANEL_COLLAPSED_KEY = 'worldview-panel-collapsed';
