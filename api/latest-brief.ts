...
// AbortSignal.timeout. Empirically (WORLDVIEW-QJ — 4 events / 19 days,
 ...
 * WORLDVIEW_PUBLIC_BASE_URL in production to prevent host-header
...
function publicBaseUrl(req: Request): string {
  const pinned = process.env.WORLDVIEW_PUBLIC_BASE_URL;
