...
export function extractConvexErrorKind(err, msg) {
  ...
  // with back-off. WORLDVIEW-QE: was previously falling through to the
  ...
  // retry-with-back-off remediation as the platform 503. WORLDVIEW-PG: was
  ...
  // 503s (WORLDVIEW-PG / WORLDVIEW-PH).
  ...
  // at error level (WORLDVIEW-PG: 11 events / 9 users). Sentry's
