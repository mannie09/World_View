...
export default function handler(req, res) {
  const url = new URL(req.url, 'https://worldview.app');
  ...
  const baseUrl = 'https://worldview.app';
  ...
  const title = `${countryName} Intelligence Brief | WorldView`;
...
<head>
  ...
  <meta name="twitter:site" content="@WorldViewApp"/>
