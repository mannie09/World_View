...
metaTitle: "Chokepoint and Freight Index Monitoring | WorldView"
...
> **Key Takeaways:** Strait of Hormuz traffic down 94.4%. WorldView tracks 8 corridors, 9 freight indices, WTO trade policy, and critical mineral concentration across one free dashboard. Data updates in real time.

The Strait of Hormuz carries 20% of the world's oil. Right now, [WorldView's](https://worldview.app) live chokepoint tracker shows traffic has dropped 94.4% week-over-week. Tanker transits have collapsed from 60+ daily to single digits. The disruption score is 99%.

This is not a hypothetical scenario for a risk assessment deck. This is happening right now, and WorldView is tracking it live.
...
WorldView's Supply Chain panel shows this in one view:
...
The Hormuz crisis is the most severe, but it is not the only corridor under pressure. WorldView tracks eight critical maritime chokepoints, each scored by disruption level, vessel traffic, and [conflict intensity](/blog/posts/track-global-conflicts-in-real-time/):
...
Traditional maritime tracking tools show you where ships are. WorldView shows you why they are not where they should be.
...
When chokepoints close, freight costs spike. WorldView tracks nine freight indices that quantify the cost impact of disruptions:
...
WorldView's Trade Policy panel tracks:
...
Gallium at 9,280 means the global supply is almost entirely dependent on a single country. When China announced gallium and germanium export controls in 2023, the semiconductor industry had no short-term alternative. WorldView makes this concentration visible, so supply chain teams can assess exposure before restrictions are announced.
...
The eight most strategically important chokepoints are: Strait of Hormuz (oil/LNG), Strait of Malacca (Asia-Europe trade), Suez Canal (Mediterranean access), Bab el-Mandeb (Red Sea entry), Panama Canal (Atlantic-Pacific), Bosporus Strait (Black Sea grain), Taiwan Strait (semiconductors), and Dover Strait (North Sea). WorldView tracks all of these except Malacca and Panama, which are currently low-risk.

---

**Open the Supply Chain panel at [worldview.app](https://worldview.app) and click "Chokepoints" for live corridor disruption scores, or "Shipping Rates" to see real-time freight indices. Free for everyone.**
