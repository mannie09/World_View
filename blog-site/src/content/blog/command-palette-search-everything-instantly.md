...
description: "Fuzzy-search 195 countries, 25+ data layers, and 150+ commands with WorldView's Cmd+K palette. Multilingual, keyboard-driven intelligence access."
metaTitle: "Cmd+K Intelligence Search Palette | WorldView"
...
In most dashboards, that's four separate navigation actions. In WorldView, it's one: **Cmd+K** (or Ctrl+K on Windows/Linux), type what you need, hit Enter. This is one of the key advantages that sets WorldView apart from [traditional intelligence tools](/blog/posts/worldview-vs-traditional-intelligence-tools/).

## The 150+ Command Universe

WorldView's command palette is a fuzzy-search interface that spans the entire platform. Hit Cmd+K and you can access:
...
With [21 languages supported](/blog/posts/worldview-in-21-languages-global-intelligence-for-everyone/), the command palette adapts to your locale. Country names and common commands are searchable in:
...
No mouse needed. For analysts who live in the keyboard, this means WorldView's entire intelligence platform is accessible without touching a pointing device.
...
The command palette turns WorldView from a visual dashboard into a queryable intelligence system. Ask it anything, get there instantly. Explore the [five dashboard variants](/blog/posts/five-dashboards-one-platform-worldview-variants/) to see how the palette adapts to different operational contexts.
...
WorldView's Cmd+K reduces the path from question to answer to a single search query. Type what you need, press Enter, and you're looking at it. For professionals who make time-sensitive decisions based on global intelligence, that speed compounds into a significant advantage.
...
**Try it now: open [worldview.app](https://worldview.app) and press Cmd+K. Your intelligence is one search away.**
