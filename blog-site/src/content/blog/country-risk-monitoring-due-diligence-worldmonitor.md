---
title: "Country Risk Due Diligence with WorldView"
...
metaTitle: "Country Risk Monitoring for Due Diligence | WorldView"
...
heroImage: "/blog/og/country-risk-monitoring-due-diligence-worldview.png"
pubDate: "2026-06-10"
...
The [Country Instability Index methodology](https://www.worldview.app/docs/methodology/cii-risk-scores) gives each country a 0-100 instability score with component-level context. Use it as a triage layer:
...
A country risk workflow should never hide where advisory input came from. WorldView's CII score exposes advisory provenance so downstream users can distinguish:
...
With REST, use the intelligence service from the [API reference](https://www.worldview.app/docs/api-reference). For production systems, generate a typed client from the bundled OpenAPI spec and keep the response fields explicit.
...
The Country Instability Index is WorldView's 0-100 country-level risk score. It combines structural and live signals such as conflict, unrest, security events, information velocity, advisory input, and other risk indicators.

**Can WorldView replace a human country analyst?**
No. WorldView is a data and workflow layer. It helps analysts collect consistent evidence, catch changes faster, and write clearer memos. Human judgment is still needed for decisions.
