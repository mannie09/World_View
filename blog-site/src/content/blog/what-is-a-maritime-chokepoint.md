...
description: "A plain-English explainer for maritime chokepoints, how WorldView tracks 13 waterways, why only seven publish live flow estimates today, and how to read status scores."
metaTitle: "What Is a Maritime Chokepoint? | WorldView"
...
That is the question WorldView's chokepoint model tries to make visible.
...
WorldView's canonical chokepoint registry currently monitors 13 waterways:
...
## How WorldView scores chokepoint status
...
For operational follow-through, connect this explainer to the [supply-chain scenario engine](/blog/posts/stress-test-supply-chain-scenario-engine-worldview/) and the [global trade route monitoring guide](/blog/posts/tracking-global-trade-routes-chokepoints-freight-costs/).

## Source transparency

WorldView's chokepoint status combines Redis-backed transit summaries, flow estimates, navigational warnings, AIS disruption matching, and a static threat taxonomy. Upstream gaps are surfaced as unavailable data rather than silently turned into calm conditions.
