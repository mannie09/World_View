...
const HANDLERS_ROOT = join(REPO_ROOT, 'server', 'worldview');
...
// imported by `server/worldview/<service>/<version>/handler.ts`).
...
function resolveHandlerFile(service, version, operationId) {
  ...
  return {
    ...
    handlerRelPath: `server/worldview/${service}/${version}/${basename}.ts`,
