...
const SERVICE_UA = 'worldview-llm/1.0';
...
const LLM_PROVIDERS = [
  ...
  },
  {
    ...
    headers: (key) => ({ 'Authorization': `Bearer ${key}`, 'Content-Type': 'application/json', 'HTTP-Referer': 'https://worldview.app', 'X-Title': 'WorldView', 'User-Agent': SERVICE_UA }),
    timeout: 20_000,
  },
];
