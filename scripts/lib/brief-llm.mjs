// Phase 3b: LLM enrichment for the WorldView Brief envelope.
//
 ...
 * server/worldview/intelligence/v1/brief-why-matters-prompt.ts
...
const DIGEST_PROSE_SYSTEM_BASE =
  'You are the chief editor of WorldView Brief. Given a ranked list of ' +
