...
console.log('  API_BASE_URL=https://api.worldview.app WORLDVIEW_SEED_REFRESH_KEY=<seed-refresh-key> WORLDVIEW_API_KEY=<read-key> node scripts/seed-resilience-scores.mjs');
