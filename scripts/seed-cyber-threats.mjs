...
// without a usable discovery timestamp. We persist a WorldView-observed
...
// Issue #4008 — pure merge of WorldView-observed first-seen. Resolves one
...
async function fetchAllThreats() {
  ...
  // WorldView-observed) before sort/proto so `firstSeenAt` is populated for
