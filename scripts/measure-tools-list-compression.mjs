...
// addition).
process.env.WORLDVIEW_VALID_KEYS = 'wm_measure_key';
...
async function fetchToolsList() {
  const req = new Request('https://worldview.app/mcp', {
    method: 'POST',
    headers: { 'Content-Type': 'application/json', 'X-WorldView-Key': 'wm_measure_key' },
