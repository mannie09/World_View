 ...
 *
 * Authentication:
 *   - WM_MCP_KEY sends X-WorldView-Key: <key>
 *   - WM_MCP_OAUTH_TOKEN sends Authorization: Bearer <token>
 *
 * Endpoint defaults to https://worldview.app/mcp; override with
...
const ENDPOINT = process.env.WM_MCP_ENDPOINT ?? 'https://worldview.app/mcp';
...
else headers['X-WorldView-Key'] = API_KEY;
