...
1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/mannie09/World_View/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@mannie09](https://github.com/mannie09) directly through GitHub.
...
- WorldView aggregates publicly available OSINT data
...
- Vulnerabilities in the WorldView codebase
...
Thank you for helping keep WorldView and its users safe! 🔒
