  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "WorldView"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "WorldView"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/worldview\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      shippingV2ServerMod, shippingV2HandlerMod,
        ...
        import('./src/generated/server/worldview/seismology/v1/service_server'),
        import('./server/worldview/seismology/v1/handler'),
        import('./src/generated/server/worldview/wildfire/v1/service_server'),
        import('./server/worldview/wildfire/v1/handler'),
        import('./src/generated/server/worldview/climate/v1/service_server'),
        import('./server/worldview/climate/v1/handler'),
        import('./src/generated/server/worldview/prediction/v1/service_server'),
        import('./server/worldview/prediction/v1/handler'),
        import('./src/generated/server/worldview/displacement/v1/service_server'),
        import('./server/worldview/displacement/v1/handler'),
        import('./src/generated/server/worldview/aviation/v1/service_server'),
        import('./server/worldview/aviation/v1/handler'),
        import('./src/generated/server/worldview/research/v1/service_server'),
        import('./server/worldview/research/v1/handler'),
        import('./src/generated/server/worldview/unrest/v1/service_server'),
        import('./server/worldview/unrest/v1/handler'),
        import('./src/generated/server/worldview/conflict/v1/service_server'),
        import('./server/worldview/conflict/v1/handler'),
        import('./src/generated/server/worldview/maritime/v1/service_server'),
        import('./server/worldview/maritime/v1/handler'),
        import('./src/generated/server/worldview/cyber/v1/service_server'),
        import('./server/worldview/cyber/v1/handler'),
        import('./src/generated/server/worldview/economic/v1/service_server'),
        import('./server/worldview/economic/v1/handler'),
        import('./src/generated/server/worldview/infrastructure/v1/service_server'),
        import('./server/worldview/infrastructure/v1/handler'),
        import('./src/generated/server/worldview/market/v1/service_server'),
        import('./server/worldview/market/v1/handler'),
        import('./src/generated/server/worldview/news/v1/service_server'),
        import('./server/worldview/news/v1/handler'),
        import('./src/generated/server/worldview/intelligence/v1/service_server'),
        import('./server/worldview/intelligence/v1/handler'),
        import('./src/generated/server/worldview/military/v1/service_server'),
        import('./server/worldview/military/v1/handler'),
        import('./src/generated/server/worldview/positive_events/v1/service_server'),
        import('./server/worldview/positive-events/v1/handler'),
        import('./src/generated/server/worldview/giving/v1/service_server'),
        import('./server/worldview/giving/v1/handler'),
        import('./src/generated/server/worldview/trade/v1/service_server'),
        import('./server/worldview/trade/v1/handler'),
        import('./src/generated/server/worldview/supply_chain/v1/service_server'),
        import('./server/worldview/supply-chain/v1/handler'),
        import('./src/generated/server/worldview/natural/v1/service_server'),
        import('./server/worldview/natural/v1/handler'),
        import('./src/generated/server/worldview/resilience/v1/service_server'),
        import('./server/worldview/resilience/v1/handler'),
        import('./src/generated/server/worldview/leads/v1/service_server'),
        import('./server/worldview/leads/v1/handler'),
        import('./src/generated/server/worldview/scenario/v1/service_server'),
        import('./server/worldview/scenario/v1/handler'),
        import('./src/generated/server/worldview/shipping/v2/service_server'),
        import('./server/worldview/shipping/v2/handler'),
      ]);
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '/widget-agent': {
          target: 'https://proxy.worldview.app',
          changeOrigin: true,
        },
        // Yahoo Finance API
        '/api/yahoo': {
