...
- src/snapshots/worldview.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/worldview.ts buildRetailerSpreadSnapshot:
...
In worldview repo: src/services/consumer-prices/index.ts
...
21. Separate PR in worldview repo: remove ke from MARKETS (Task 11)
