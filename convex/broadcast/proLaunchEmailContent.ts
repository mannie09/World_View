...
export const PRO_LAUNCH_FROM = "Elie from WorldView <news@worldview.app>";
export const PRO_LAUNCH_REPLY_TO = "elie@worldview.app";
export const PRO_LAUNCH_SUBJECT = "You waitlisted WorldView PRO. It's now live.";
...
export const PRO_LAUNCH_UPGRADE_URL =
  "https://worldview.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email";

// CAN-SPAM physical address. Required in every commercial email footer.
// Update if the company physical address changes.
export const PRO_LAUNCH_PHYSICAL_ADDRESS = "WorldView FZ LLC, Dubai - United Arab Emirates";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of WorldView. PRO launched today (https://worldview.app/pro). I'm writing because you signed up a month ago, when the product was smaller and different.

Here's what it is now.

WorldView stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.
...
It grew a dedicated energy variant. energy.worldview.app: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.
...
And it became something your AI can use. WorldView is accessible via REST API and MCP server. Connect it to Claude, ChatGPT, or Cursor in three minutes, and 28 live data tools become available inside your AI chat. Ask Claude "what's happening in the Taiwan Strait right now" and it pulls real-time data instead of training-set memories.

More than half of this didn't exist 45 days ago. The open-source repo (https://github.com/mannie09/World_View) crossed 50,000 GitHub stars in the same window. That's the build pace.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at https://worldview.app/docs/documentation. Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
→ Upgrade to PRO: https://worldview.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email
...
<p>I'm Elie, founder of WorldView. <a href="https://worldview.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
<p>Here's what it is now.</p>
<p>WorldView stopped being only a real-time monitoring dashboard, though it still excels at that. It's also a research tool now. It tracks what's happening, and it forecasts what happens next: scenario probabilities on conflicts, market reactions to headlines, supply-chain shock paths, country stability trajectories. You read the present and stress-test the future in the same place.</p>
<p><strong>The dashboard grew sideways.</strong> Conflicts stream live alongside sanctions, regime shifts, GPS jamming, displacement, climate anomalies. Bilateral trade flows, tariff trends, chokepoint indices, route disruption, cost-shock simulations, stability scoring across 137 countries with deep coverage on 40+ indicators. AI stock analysis with price targets, backtesting, a scanner for tickers trending on Reddit. Live aircraft tracking, civilian and military: fighter scrambles over the Taiwan Strait, carrier strike groups in the Persian Gulf, special-ops by callsign, 100+ airports for delays and cascades. Useful when something breaks at 3 a.m. and a price chart won't tell you why.</p>
<p><strong>It grew a dedicated energy variant.</strong> <a href="https://energy.worldview.app" style="color:#0066cc;">energy.worldview.app</a>: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.</p>
...
<p><strong>And it became something your AI can use.</strong> WorldView is accessible via REST API and MCP server. Connect it to Claude, ChatGPT, or Cursor in three minutes, and 28 live data tools become available inside your AI chat. Ask Claude <em>"what's happening in the Taiwan Strait right now"</em> and it pulls real-time data instead of training-set memories.</p>
<p>More than half of this didn't exist 45 days ago. The <a href="https://github.com/mannie09/World_View" style="color:#0066cc;">open-source repo</a> crossed 50,000 GitHub stars in the same window. That's the build pace.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="https://worldview.app/docs/documentation" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="https://worldview.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=cta-button" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
