...
description: "How WorldView scores 13 monitored maritime chokepoints, including the seven-item live-flow subset with EIA energy baselines."
---

## What we track

WorldView has **13 monitored waterways** in the canonical chokepoint registry and the
...
`server/worldview/supply-chain/v1/get-chokepoint-status.ts` and weighted in
`server/worldview/supply-chain/v1/_scoring.mjs`.
...
[public repository](https://github.com/mannie09/World_View/issues).
