---
title: "Contributing"
description: "Code style guidelines, pull request process, contribution types, and security practices for the WorldView project."
---
...
By contributing to WorldView, you agree that your contributions are licensed under AGPL-3.0. See the [License](/license) page for full terms, commercial licensing, and common scenarios.
