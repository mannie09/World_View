...
WorldView runs six thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **WorldView** | worldview.app | Geopolitics, military, conflicts, infrastructure |
| **Tech Monitor** | tech.worldview.app | AI/ML, startups, cybersecurity, tech ecosystems |
| **Finance Monitor** | finance.worldview.app | Markets, central banks, Gulf FDI, commodities |
| **Commodity Monitor** | commodity.worldview.app | Mining, metals, energy, critical minerals |
| **Happy Monitor** | happy.worldview.app | Good news, conservation, positive global trends |
| **Energy Monitor** | energy.worldview.app | Energy security, oil and gas, chokepoints, policy response |

### AI Intelligence Layer

WorldView uses a multi-tier AI pipeline to process and summarize information:
...
WorldView aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
WorldView serves several audiences:
...
| Feature | WorldView | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
- **Web**: Available at worldview.app and variant subdomains
...
WorldView is actively developed with planned expansions across several areas:
...
- **API and MCP access** for developers and organizations to integrate WorldView data into their own tools
...
**Q: Where does WorldView get its data?**
...
**Q: Does WorldView track users or sell data?**
...
A: Yes. WorldView is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: WorldView was created by Mannie. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed WorldView or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, use the documented REST API, OpenAPI specs, or MCP server. Please attribute "WorldView (worldview.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. WorldView aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: WorldView is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
- **GitHub**: github.com/mannie09/World_View
- **Website**: worldview.app

---

*This document was last updated March 2026. WorldView is an independent, open-source project licensed under AGPL-3.0.*
