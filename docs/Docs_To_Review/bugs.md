...
**Description**
`PANEL_ORDER_MIGRATION_KEY` is `worldview-panel-order-v1.9` but the `console.log` says `"Migrated panel order to v1.8 layout"`.
...
**Description**
The Polymarket dev proxy targets `https://worldview.app` (the live production site).
