---
title: "License"
description: "WorldView licensing terms: AGPL-3.0-only code license, optional commercial licensing, and trademark policy separation."
---

WorldView source code is licensed under the [GNU Affero General Public License v3.0 (AGPL-3.0-only)](https://www.gnu.org/licenses/agpl-3.0.html).

This page is a plain-language summary for contributors and users. It is not legal advice and does not replace the license text in [`LICENSE`](https://github.com/mannie09/World_View/blob/main/LICENSE).
...
- use WorldView for personal, educational, research, nonprofit, or commercial purposes
...
- combine WorldView code into proprietary products in ways the AGPL would not permit
...
Contact the maintainer through the [GitHub repository](https://github.com/mannie09/World_View) to discuss commercial licensing.

## Trademark and branding

The AGPL covers copyright permissions for the code. It does not grant rights to use the WorldView name, logo, visual identity, or official project branding.
...
**Using WorldView's public API in your own tool**: API terms of service may apply separately from the source-code license.
