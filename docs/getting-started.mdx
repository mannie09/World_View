...
description: "Installation instructions, tech stack overview, project structure, API dependencies, and setup guide for WorldView."
---
This guide covers everything you need to set up WorldView locally, from prerequisites and installation to understanding the project structure and API dependencies.
...
WorldView has three setup tracks depending on what you're doing.
...
├── worldview/<domain>/    # 34 proto-backed domain handler implementations
