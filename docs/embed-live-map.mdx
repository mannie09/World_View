...
description: "Add the public WorldView live map to an article or internal page with an iframe."
---

WorldView exposes a public map-only iframe at `/embed`.
...
Each embed includes a permanent attribution link back to WorldView with source campaign parameters.
