# WorldView — Community Promotion Guide

Thank you for helping spread the word about WorldView! This guide provides talking points, must-see features, and visual suggestions to help you create compelling content for your audience.
...
**Longer description**: WorldView aggregates 500+ news feeds, military tracking, financial markets, conflict data, protest monitoring, satellite imagery, and AI-powered analysis into a single unified dashboard with an interactive globe. Available as a web app, desktop app (macOS/Windows/Linux), and installable PWA.
...
| Link | Description |
|------|-------------|
| [worldview.app](https://worldview.app) | Main dashboard — geopolitics, military, conflicts |
| [tech.worldview.app](https://tech.worldview.app) | Tech variant — startups, AI/ML, cybersecurity |
| [finance.worldview.app](https://finance.worldview.app) | Finance variant — markets, exchanges, central banks |
| [commodity.worldview.app](https://commodity.worldview.app) | Commodity variant — mining, metals, energy, supply chains |
| [happy.worldview.app](https://happy.worldview.app) | Happy variant — positive news, breakthroughs, conservation |
| [energy.worldview.app](https://energy.worldview.app) | Energy variant — oil, gas, chokepoints, energy security |
| [GitHub](https://github.com/mannie09/World_View) | Source code (AGPL-3.0) |
...
- **Name**: "WorldView" (two words, capitalized)
- **Tagline**: "Real-time global intelligence dashboard"
- **License**: AGPL-3.0 (free and open source)
- **Creator**: Credit "WorldView by Mannie" or link to the GitHub repo
...
We genuinely appreciate community members helping grow WorldView's reach. Feel free to interpret these guidelines creatively — there's no strict template. The most compelling content comes from showing what YOU find most interesting or useful about the tool.
