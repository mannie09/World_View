...
description: "WorldView platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
WorldView runs six specialized variants from a single codebase, each optimized for different monitoring needs.
...
| **😊 Happy Monitor** | [happy.worldview.app](https://happy.worldview.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.worldview.app](https://finance.worldview.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.worldview.app](https://commodity.worldview.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.worldview.app](https://energy.worldview.app) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The finance variant ([finance.worldview.app](https://finance.worldview.app)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.worldview.app](https://commodity.worldview.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.worldview.app](https://happy.worldview.app)) curates positive news, human progress data, and uplifting stories.
