...
- **Route graph** — `/api/supply-chain/v1/get-route-explorer-lane` (generated from `proto/worldview/supply_chain/v1/`). Returns primary route id, chokepoint exposures, bypass corridors, war-risk tier, and disruption score.
