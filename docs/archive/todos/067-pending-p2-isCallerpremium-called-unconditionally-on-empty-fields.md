...
## Technical Details
- Files: `server/worldview/news/v1/summarize-article.ts:42`, `server/worldview/intelligence/v1/deduct-situation.ts:26`, `server/worldview/intelligence/v1/get-country-intel-brief.ts`
