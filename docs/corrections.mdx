...
WorldView's Energy Atlas publishes evidence bundles — not opinions —
...
- **Evidence bundles on every asset.** Click any pipeline, storage
  facility, or shortage pin on the [Energy Atlas](https://energy.worldview.app)
...
- An automated correction-intake pipeline. If you spot something
  ...
  [worldview.app](https://worldview.app) or open a GitHub issue
  at the [public repository](https://github.com/mannie09/World_View/issues).
