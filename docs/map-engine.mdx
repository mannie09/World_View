---
title: "Map Engine"
description: "3D globe and flat map rendering, textures, shaders, clustering, and mobile touch gestures in WorldView."
---
...
Country boundaries, boundary overrides, and the geocoding service are documented in [Maps & Geocoding](/maps-and-geocoding). All large static files are served from R2 CDN via `maps.worldview.app`.
