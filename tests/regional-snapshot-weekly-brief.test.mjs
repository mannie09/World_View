...
const handlerSrc = readFileSync(resolve(root, 'server/worldview/intelligence/v1/get-regional-brief.ts'), 'utf-8');
const handlerIndexSrc = readFileSync(resolve(root, 'server/worldview/intelligence/v1/handler.ts'), 'utf-8');
...
const protoSrc = readFileSync(resolve(root, 'proto/worldview/intelligence/v1/get_regional_brief.proto'), 'utf-8');
const serviceProtoSrc = readFileSync(resolve(root, 'proto/worldview/intelligence/v1/service.proto'), 'utf-8');
...
describe('proto definition', () => {
  ...
  it('imports the proto file from service.proto', () => {
    assert.match(serviceProtoSrc, /import "worldview\/intelligence\/v1\/get_regional_brief\.proto"/);
  });
