...
describe('SWF classification manifest — shipped YAML', () => {
  ...
  it('source comments do not preserve the superseded full-coverage no-SWF semantics', () => {
    const surfaces = [
      ...
      ['server/worldview/resilience/v1/_indicator-registry.ts', new URL('../server/worldview/resilience/v1/_indicator-registry.ts', import.meta.url)],
      ['server/worldview/resilience/v1/_dimension-scorers.ts', new URL('../server/worldview/resilience/v1/_dimension-scorers.ts', import.meta.url)],
