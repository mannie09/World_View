 ...
 *   - server/worldview/cyber/v1/_shared.ts
 *   - server/worldview/military/v1/get-usni-fleet-report.ts
 *   - server/worldview/news/v1/_shared.ts  (+ dedup.mjs + hash.ts)
 *   - server/worldview/infrastructure/v1/get-cable-health.ts
 *
...
import {
  ...
  SEVERITY_RANK,
  type RawThreat,
} from '../server/worldview/cyber/v1/_shared.ts';
...
} from '../server/worldview/military/v1/get-usni-fleet-report.ts';
import type { USNIFleetReport } from '../src/generated/server/worldview/military/v1/service_server.ts';

// ---------------------------------------------------------------------------
// News domain helpers
// ---------------------------------------------------------------------------
import { deduplicateHeadlines } from '../server/worldview/news/v1/dedup.mjs';
import { buildArticlePrompts, hashString } from '../server/worldview/news/v1/_shared.ts';
...
import {
  ...
  processNgaSignals,
  computeHealthMap,
} from '../server/worldview/infrastructure/v1/get-cable-health.ts';
