...
//   1. server/worldview/intelligence/v1/_shared.ts — canonical writer
//      (CLASSIFY_CACHE_PREFIX constant + buildClassifyCacheKey helper)
//   2. server/worldview/news/v1/list-feed-digest.ts — digest reader
...
const sharedSrc = readFileSync(
  resolve(repoRoot, 'server/worldview/intelligence/v1/_shared.ts'),
  'utf-8',
);
