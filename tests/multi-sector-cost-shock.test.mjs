...
} from '../server/worldview/supply-chain/v1/_multi-sector-shock.ts';
...
// ========================================================================
// 2. sebuf handler: server/worldview/supply-chain/v1/get-multi-sector-cost-shock.ts
// ========================================================================

describe('getMultiSectorCostShock sebuf handler', () => {
  const src = readSrc('server/worldview/supply-chain/v1/get-multi-sector-cost-shock.ts');
