...
function makeCtx(headers = {}) {
  return {
    request: new Request('https://worldview.app/api/leads/v1/register-interest', {
      method: 'POST',
...
describe('LeadsService.registerInterest desktop auth', () => {
  beforeEach(async () => {
    ...
    const mod = await import('../server/worldview/leads/v1/register-interest.ts');
    ...
    const gen = await import('../src/generated/server/worldview/leads/v1/service_server.ts');
