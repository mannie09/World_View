...
async function captureRpcFetches(toolName, params) {
  ...
  result = await rpcTool(toolName)._execute(params, 'https://worldview.app', {
    kind: 'env_key',
...
describe('MCP news/auth public contract', () => {
  ...
  it('MCP-facing docs and fixture helpers do not teach stale API-key prefixes', () => {
    ...
    assert.match(quickstart, /X-WorldView-Key/, 'quickstart must teach API keys via X-WorldView-Key');
