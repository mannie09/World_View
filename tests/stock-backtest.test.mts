...
import { backtestStock } from '../server/worldview/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/worldview/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/worldview/market/v1/service_client.ts';
